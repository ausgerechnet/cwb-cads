...
<div className="grid gap-12 lg:grid-cols-2">
  ...
  <section className="space-y-4">
    ...
    <p>
      Need an account with full access?  Please contact <a
  ...
  <section className="max-w-4xl space-y-6">
    ...
    <div className="space-y-8">
      ...
      {/* Screenshots */}
      <aside className="lg:col-span-1 space-y-8 lg:pt-24">
        {images.map((image, index) => (
          ...
          >
            <img
              ...
              className="rounded-lg shadow border w-full object-contain hover:opacity-90 transition"
            />
          </figure>
        ))}
      </aside>
