...
class DevConfig(Config):
    ...
    CORPORA = '/home/timm/Projekte/corpora/cads/corpora.json'
    CCC_REGISTRY_DIR = '/home/timm/Projekte/corpora/cads/registry/'
    CCC_LIB_DIR = 'instance/cwb-cads-ccc-lib-dev/'  
